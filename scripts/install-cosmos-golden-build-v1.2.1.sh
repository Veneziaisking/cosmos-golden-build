#!/usr/bin/env bash
# =============================================================================
# Cosmos Cloud — Golden Build v1.2.1 Installer
# Target: Debian GNU/Linux 13 (trixie)
#
# Prepares a fresh or existing Debian 13 server for the Golden Build v1.2.1
...
#
# Usage: sudo bash install-cosmos-golden-build-v1.2.1.sh
# =============================================================================
set -euo pipefail
...
# CONSTANTS
# =============================================================================
readonly GOLDEN_BUILD_VERSION="1.2.1"
...
if "${COSMOS_INIT_PENDING}"; then
    ...
    printf "       sudo bash validate-golden-build-v1.2.1.sh\n\n"
else
